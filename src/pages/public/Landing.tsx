...
export default function Landing() {
  ...
  const features = [
    {
      icon: Clock,
      title: 'Live Bidding',
      description: 'Real-time auctions with instant updates',
    },
    {
      icon: Shield,
      title: 'Secure Payments',
      description: 'Multiple payment methods with buyer protection',
    },
    {
      icon: Users,
      title: 'Verified Sellers',
      description: 'Trusted sellers with verified badges',
    },
    {
      icon: Truck,
      title: 'Nationwide Shipping',
      description: 'Delivery across the Philippines',
    },
    {
      icon: CreditCard,
      title: 'Buyer Protection',
      description: 'Full refund guarantee on eligible items',
    },
    {
      icon: TrendingUp,
      title: 'Real-time Alerts',
      description: 'Never miss a bid with instant notifications',
    },
  ]
  ...
  const howItWorks = [
    ...
    },
    {
      ...
      description: 'Browse auctions or search for specific items',
    },
    {
      step: 3,
      title: 'Place Your Bid',
      description: 'Bid in real-time and track your auctions',
    },
    {
      step: 4,
      title: 'Win & Pay',
      description: 'Complete payment and receive your item',
    },
  ]
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <form onSubmit={handleSearch} className="mt-8 max-w-xl">
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-12 pr-32 py-4 bg-white rounded-2xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-teal-500/30 text-lg"
                  />
                  <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-6 h-6 text-gray-400" />
                  <button
                    type="submit"
                    className="absolute right-2 top-1/2 -translate-y-1/2 bg-teal-600 text-white px-6 py-2.5 rounded-xl font-semibold hover:bg-teal-700 transition-colors"
                  >
                    Search
                  </button>
                </div>
              ...
              {/* Trust Badges */}
              <div className="mt-10 flex flex-wrap justify-center lg:justify-start items-center gap-6 text-gray-400 text-sm">
                  ...
                  {featuredAuctions.length > 0 ? (
                    ...
                    >
                      {featuredAuctions.map((auction) => (
                        <div key={auction.id} className="w-full flex-shrink-0 px-2">
                          <Link
                          ...
                          >
                            ...
                            <div className="p-4">
                              <h4 className="font-semibold text-gray-900 truncate">{auction.title}</h4>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
            {categories.map((category, idx) => (
              <Link
                ...
                className="group p-6 bg-gray-50 rounded-2xl text-center hover:bg-teal-50 hover:shadow-lg transition-all animate-fade-in"
                style={{ animationDelay: `${idx * 0.05}s` }}
              >
                <div className="w-16 h-16 mx-auto mb-4 bg-white rounded-2xl flex items-center justify-center shadow-sm group-hover:shadow-md transition-shadow">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, idx) => (
              <div
                key={feature.title}
                className="bg-white p-8 rounded-2xl shadow-sm hover:shadow-xl transition-all animate-fade-in group"
                style={{ animationDelay: `${idx * 0.1}s` }}
              >
                <div className="w-14 h-14 bg-gradient-to-br from-teal-500 to-teal-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {howItWorks.map((step, idx) => (
              <div key={step.step} className="text-center relative">
                <div className="w-20 h-20 mx-auto bg-white rounded-full flex items-center justify-center shadow-lg mb-6">
