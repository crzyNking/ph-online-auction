      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          ...
          <div className="relative h-32 bg-gradient-to-r from-teal-500 to-teal-600">
            <div className="absolute -bottom-12 left-6">
              <div className="relative">
                <div className="w-24 h-24 rounded-2xl border-4 border-white bg-white flex items-center justify-center overflow-hidden">
                  {user?.avatar_url ? (
          ...
          <div className="pt-16 pb-8 px-6">
            {/* Verification Badge */}
            {user?.verified && (
              <div className="flex items-center gap-2 mb-6 p-3 bg-teal-50 rounded-xl">
                <Shield className="w-5 h-5 text-teal-600" />
                <span className="text-teal-700 font-medium">Verified Seller</span>
              </div>
            )}
