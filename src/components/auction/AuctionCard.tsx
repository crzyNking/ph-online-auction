    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-gray-500 text-sm mt-1">Condition: {auction.condition}</p>
    ...
    return (
      ...
      >
        ...
        <div className="p-3">
          ...
          <p className="font-display font-bold text-teal-600 mt-2">
            {formatCurrency(auction.current_price)}
          </p>
  ...
  return (
    ...
    >
      <div className="aspect-[4/3] relative overflow-hidden">
        ...
        <button
          className="absolute bottom-3 right-3 w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-lg hover:bg-teal-50 transition-colors group-hover:scale-110"
      ...
      <div className="p-4">
        ...
        <div className="flex items-end justify-between mt-4">
          <div>
            <p className="text-xs text-gray-500">Current Bid</p>
            <p className="font-display text-2xl font-bold text-teal-600">
              {formatCurrency(auction.current_price)}
            </p>
          </div>
        ...
        <div className="flex items-center gap-4 mt-4 pt-4 border-t border-gray-100">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-sm text-gray-600">{auction.seller?.username}</span>
